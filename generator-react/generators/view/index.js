...
module.exports = class extends Generator {
    ...
    writing() {
        ...
        this.fs.copyTpl(
            ...
            this.destinationPath(`src/view/${compName}/${compName}.js`),
            {
                title: compName,
                className: className
            }
        ...
        this.fs.copyTpl(
            ...
            this.destinationPath(`src/view/${className}/${className}.scss`),
            {
                title: className
            }
        );
        ...
        this.fs.copyTpl(
            ...
            this.destinationPath(`src/view/${compName}/${compName}.stories.js`),
            {
                title: compName
            }
        );
